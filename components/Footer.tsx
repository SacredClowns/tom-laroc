    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col gap-10 md:flex-row md:justify-between">
        ...
        <div className="flex gap-16">
          <div className="flex flex-col gap-3 text-xs uppercase font-display font-medium tracking-[0.2em]">
      ...
      <p className="mt-16 text-[10px] uppercase font-display font-medium tracking-[0.2em]" style={{ color: "var(--muted)" }}>
