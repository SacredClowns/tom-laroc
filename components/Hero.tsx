    ...
    <section className="relative flex h-screen min-h-[640px] w-full items-center justify-center overflow-hidden">
      ...
      <div className="pointer-events-none relative z-10 flex flex-col items-center px-6 text-center">
        ...
        <motion.div
          ...
          className="pointer-events-auto mt-10 flex items-center gap-5 text-xs uppercase font-display font-medium tracking-[0.18em]"
        >
      ...
      <div
        className="absolute bottom-8 left-1/2 z-10 -translate-x-1/2 text-[10px] uppercase font-display font-medium tracking-[0.18em]"
        style={{ color: "var(--muted)" }}
      >
