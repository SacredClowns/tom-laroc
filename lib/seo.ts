...
export const SITE = {
  ...
  description:
    "Tom Laroc is an artist and designer first — the bridge between contemporary graphic design and AI. Design-led AI strategy, creative direction, generative art, and teaching. Based in South Beach, Miami; working worldwide.",
  city: "Miami Beach",
  region: "FL",
  country: "US",
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Artist and designer; the bridge between contemporary graphic design and AI. Born in the Bronx, based in South Beach, Miami for 20+ years.",
        homeLocation: {
          "@type": "Place",
