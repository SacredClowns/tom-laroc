    ...
    <main className="min-h-screen">
      ...
      <section id="engagements" className="mx-auto max-w-6xl px-6 py-28">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {PACKAGES.map((p) => (
            ...
            >
              {p.featured && (
                <p
                  className="mb-4 text-[10px] uppercase font-display font-medium tracking-[0.18em]"
                  style={{ color: "var(--accent)" }}
                >
                  Most popular
                </p>
              ...
              <a
                href="#start"
                className="mt-8 rounded-full px-6 py-3 text-center text-xs uppercase font-display font-medium tracking-[0.2em]"
                style={
                  p.featured
        ...
        >
          ...
          <a
            href="#start"
            className="shrink-0 rounded-full border px-6 py-3 text-xs uppercase font-display font-medium tracking-[0.2em]"
      ...
      <section className="mx-auto max-w-4xl px-6 py-24 text-center">
        ...
        <p
          className="mt-6 text-xs uppercase font-display font-medium tracking-[0.18em]"
          style={{ color: "var(--accent)" }}
        >
          Tom Laroc
        </p>
